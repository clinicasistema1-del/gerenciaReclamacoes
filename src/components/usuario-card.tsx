...
export function UsuarioCard({
  ...
  async function confirmar() {
    ...
    if (!result.ok) {
      ...
      setErro(
        `Não é possível excluir. Há ${result.reclamacoes} reclamação(ões), ${result.tratamentos} tratamento(s) e ${result.historicos} registro(s) de histórico vinculados.`
      );
      return;
    }
    setAberto(false);
          ...
          <div className="w-full max-w-md rounded-xl bg-white p-6 shadow-xl">
            ...
            {ehLogado ? (
              ...
              <p className="mt-2 text-sm text-red-700">
                ...
                tratamento(s) e {usuario.historicos} registro(s) de histórico
                vinculados.
              </p>
            )}
